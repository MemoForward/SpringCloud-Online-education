  ...
  <div class="app-container">
    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="课程讲师">
        <el-select filterable v-model="courseInfo.teacherId" placeholder="请选择">
          <el-option
  ...
  data() {
    return {
      ...
      courseInfo: {
        ...
        description: "",
        cover:
          "https://memo-edu.oss-cn-beijing.aliyuncs.com/avatar/2020/07/04/90152ae3a58f4b0e9cf254ba8dc15439file.png",
        price: 0
      },
